...
void komunikasi() {
  ...
  if (d == "R12>" || d == "r12>" ) {    // untuk retry, cek lagi posisiny dmn biar biso tau vballik lewat mano
    if (langkah == 2 || langkah == 3  ) {
      langkah = 16;
    }
    if (langkah == 1 ) {
      langkah = 16;
    }
    if (langkah == 5 || langkah == 6) {
      langkah = 13;
    }
  //   ledData(0, 0, 0, 0, 0, 0);
  ...
  // if (d == "R2>" || d == "r2>"  ) {
    ...
    if (langkah2 == 3 || langkah2 == 4) {
      langkah2 = 15;
    }
    if (langkah2 == 1 ) {
      langkah2 = 15;
    }
    if (langkah2 == 5 || langkah2 == 6 ) {
      langkah2 = 15;
    }
    ledData(0, 0, 0, 0, 0, 0);
    //BUTUH DI RISET LAGI MENYESUAIKAN GERAKAN DI LAPANGAN NANTI
