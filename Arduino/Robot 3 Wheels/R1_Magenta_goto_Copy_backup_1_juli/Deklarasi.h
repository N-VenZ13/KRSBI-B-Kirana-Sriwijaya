...
#define enA 16  //x  //SUDAH BENER JANGAN DIKUTAK KATIK
#define enB 18  //x
#define enC 17  //y
#define enD 19  //y
...
#define sharpGP  A1  //INI YANG SGP DALEM
#define bkn A0       // SGP KANAN
#define bkr A2       // SGP KIRI
