...
//  //================================== Mode Komunikasi ===============================================//
//  //Kondisi misal Basestation ngerem s1 dan kondisi di langkah5 = 0 maka program masuk ke langkah5 =1 Moda1
...
//   nyampe = false;
//   step = 3;                          //Robot ngoper bola ke R1
//   dapetBola = false;
...
//   nyampe = false;
//   step = 4;                        //Robot bergerak mundur untuk kembali ke posisi awal
//   while (nyampe == false) {
//     int kec = 140;
//     if (r <= 2) kec /= 2;
//     update_data();
